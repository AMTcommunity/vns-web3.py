...
from vns_web3.utils.blocks import (
    is_hex_encoded_block_hash,
)
from vns_web3.utils.contracts import (
    encode_abi,
...
from vns_web3.utils.datatypes import (
...
from vns_web3.utils.empty import (
    empty,
)
...
from vns_web3.utils.events import (
    get_event_data,
)
from vns_web3.utils.filters import (
    construct_event_filter_params,
)
from vns_web3.utils.function_identifiers import (
    FallbackFn,
)
...
class Contract:
    ...
    * Deploy a new smart contract using :py:meth:`Contract.deploy`
    ...
    def deploy(cls, transaction=None, args=None, kwargs=None):
        ...
        txn_hash = cls.web3.vns.sendTransaction(deploy_transaction)
        return txn_hash
    ...
    def eventFilter(self, event_name, filter_params={}):
        ...
        log_filter = self.web3.vns.filter(event_filter_params)
    ...
    def estimateGas(self, transaction=None):
        ...
        if self.web3.vns.defaultAccount is not empty:
            estimate_transaction.setdefault('from', self.web3.vns.defaultAccount)
